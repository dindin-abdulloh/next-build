...
const Headline = ({isEnglish}) => {
    return (
        <>
            {
                isEnglish ? 
                    <div className="lg:text-left text-center px-6 lg:px-0 mt-14 md:mt-[150px] lg:mt-[200px]">
                ...
                <div className="lg:text-right text-center px-6 lg:px-0 mt-14 md:mt-[150px] lg:mt-[200px]">
